...
# Modified by bilalriaz for  the cases when M is not matrix but cost tensor. 


def barycenter1(A, M, weights=None, verbose=False, log=False, solver='highs-ipm'):
    ...
    for i in range(n_distributions):
        c = np.concatenate((c, M[i].ravel() * weights[i]))
